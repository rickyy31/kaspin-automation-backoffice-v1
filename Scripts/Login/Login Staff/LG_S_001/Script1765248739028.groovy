...
// 3. Pastikan field "Masuk Sebagai" terpilih "Staff".
// Kita verifikasi bahwa label 'Staff' memiliki class 'active'
TestObject dropdownSebagai = findTestObject('Halaman Login Owner/select_Daftar di sini_sebagai')

WebUI.waitForElementClickable(dropdownSebagai, 10)

WebUI.selectOptionByValue(dropdownSebagai, 'staff', false)

println('Dropdown "Masuk Sebagai" berhasil dipilih: Staff')

WebUI.delay(3 // Tambahkan delay 3 detik untuk menunggu
    )

// 4. Masukkan E-Mail Owner yang valid.
WebUI.setText(findTestObject('Login Repo/LG_002 - Login valid as staff/Page_Kasir Pintar  Aplikasi Kasir Digital untuk UMKM Indonesia/input_E-mail_Staff'), 
    'rickyauto1staff1@yopmail.com')
...
WebUI.setText(findTestObject('Login Repo/LG_002 - Login valid as staff/Page_Kasir Pintar  Aplikasi Kasir Digital untuk UMKM Indonesia/input_Password_Staff'), 
    'manual123' // Ganti dengan hasil enkripsi dari 'manual123'
    )
...
// Definisikan 2 kemungkinan URL sukses
...
String urlProDashboard = 'https://laravel-qa.kpntr.com/account/other'
...
if (actualUrl.equals(urlAppTour)) {
    ...
    if (dashboardUrl.equals(urlProDashboard) || dashboardUrl.equals(urlFreeDashboard)) {
        KeywordUtil.markPassed('Berhasil melewati App Tour dan diarahkan ke Dashboard: ' + dashboardUrl // Jika URL tidak cocok dengan salah satu dari tiga di atas, maka GAGAL
            )
    } else {
